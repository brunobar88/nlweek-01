...
const Detail = () => {
    ...
    function handleWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=tenho interesse nos seus serviços de coleta`)
    }
    ...
    //aqui ficaria retornado uma tela de loading mas pra agilizar retornamos null. enquanto o point não carrega.
    if(!data.point) {
        return null;
    }
